...
# 引子
不得不说用`Markdown`写文章是一件很舒服的事情，而且更棒的是Github不但极为方便的存储、多人协助、发布markdown文档，而且`VS Code、Atom`集成的很好。每一个IT的人都应该使用这种轻量级的HTML描述脚本。
* 但是很可惜，Markdown是洋人发明的，适合英文写作，中文写作还是有点别扭。