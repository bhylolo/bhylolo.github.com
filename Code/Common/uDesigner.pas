...
type
  ...
  TRegisterCustomModule = class
    (TDictionary<TComponentClass, TCustomModuleClass>)
  private
    class var RegisterCustomModule: TRegisterCustomModule;
  public
    class function GetRegisterCustomModule: TRegisterCustomModule;
  end;
...
begin
  TRegisterCustomModule.GetRegisterCustomModule.AddOrSetValue
    (ComponentBaseClass, CustomModuleClass);
end;
...
{ TRegisterCustomModule }

class function TRegisterCustomModule.GetRegisterCustomModule
  : TRegisterCustomModule;
begin
  if not Assigned(RegisterCustomModule) then
    RegisterCustomModule := TRegisterCustomModule.Create();
  Result := RegisterCustomModule;
end;
...
RegisterCustomModuleProc := InternalRegisterCustomModuleProc;
